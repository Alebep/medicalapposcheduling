...
{
    public partial class MenuExam : Form
    {
        public MenuExam()
        {
            InitializeComponent();
        ...
        private void типыМедицинскогоОсмотраToolStripMenuItem_Click(object sender, EventArgs e)
        {
            AbrirFormulario<RegisterExam>();
        }

        private void медицинскийОсмотрToolStripMenuItem_Click(object sender, EventArgs e)
        {
